...
class PlistBuddy {
        ...
        return projectVersionHelper_1.ProjectVersionHelper.getReactNativeVersions(projectRoot)
            ...
            if (productName) {
                ...
                if (!executableList.length) {
                    ...
                    configurationFolder = this.getBuildPath(iosProjectRoot, projectWorkspaceConfigName, configuration, scheme, sdkType);
    ...
    getBuildPath(iosProjectRoot, projectWorkspaceConfigName, configuration, scheme, sdkType) {
     ...
     * @returns {string | null}
     */
    getTargetBuildDir(buildSettings) {
