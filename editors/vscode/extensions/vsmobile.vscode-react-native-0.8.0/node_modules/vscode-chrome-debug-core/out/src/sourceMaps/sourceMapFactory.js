...
class SourceMapFactory {
    constructor(_webRoot, _sourceMapPathOverrides, _enableSourceMapCaching) {
        ...
        return sourceMapContentsP.then(contents => {
            if (contents) {
                try {
                    ...
                    return new sourceMap_1.SourceMap(pathToGenerated, contents, this._webRoot, this._sourceMapPathOverrides);
                }
                catch (e) {
