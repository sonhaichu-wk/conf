...
class TelemetryHelper {
    ...
    static addPropertyToTelemetryProperties(propValue, propName, properties = {}) {
        properties[propName] = {
            value: propValue,
            isPii: false,
        };
    ...
    static sendErrorEvent(eventName, error, errorDescription, isPii = true) {
    ...
    static addTelemetryEventErrorProperty(event, error, errorDescription, errorPropPrefix = "", isPii = true) {
