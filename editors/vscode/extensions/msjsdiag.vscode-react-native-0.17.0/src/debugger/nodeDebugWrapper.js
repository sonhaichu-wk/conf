...
exports.getProjectRoot = exports.makeAdapter = exports.makeSession = void 0;
const Q = require("q");
    ...
    return class extends debugSessionClass {
        ...
        launch(request) {
            this.requestSetup(request.arguments)
                ...
                .then((packagerPort) => {
                this.attachRequest(Object.assign(Object.assign({}, request), { arguments: Object.assign(Object.assign({}, request.arguments), { port: packagerPort }) }));
            })
                .catch(error => {
        ...
        attach(request) {
            this.requestSetup(request.arguments)
                ...
                .then((packagerPort) => {
                this.attachRequest(Object.assign(Object.assign({}, request), { arguments: Object.assign(Object.assign({}, request.arguments), { port: request.arguments.port || packagerPort }) }));
            })
                .catch(error => {
                this.bailOut(error.data || error.message);
            });
        ...
        attachRequest(request) {
            ...
            return projectVersionHelper_1.ProjectVersionHelper.getReactNativeVersions(request.arguments.cwd, true)
                .then(versions => {
...
function getProjectRoot(args) {
    ...
    try {
        ...
        vscode_chrome_debug_core_1.logger.verbose(`'projectRoot' setting is not found: ${settingsPath} file doesn't exist or its content is incorrect.`);
