...
class IOSPlatform extends generalMobilePlatform_1.GeneralMobilePlatform {
    ...
    runApp() {
        ...
        return telemetryHelper_1.TelemetryHelper.generate("iOSPlatform.runApp", extProps, () => {
            ...
            return new outputVerifier_1.OutputVerifier(() => this.generateSuccessPatterns(this.runOptions.reactNativeVersions.reactNativeVersion), () => Q(IOSPlatform.RUN_IOS_FAILURE_PATTERNS), "ios")
                .process(runIosSpawn);
        });
    }
