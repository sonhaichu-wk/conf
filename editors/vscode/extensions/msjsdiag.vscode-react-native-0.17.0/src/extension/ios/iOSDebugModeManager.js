...
exports.IOSDebugModeManager = void 0;
const Q = require("q");
...
class IOSDebugModeManager {
    constructor(iosProjectRoot, projectRoot, scheme) {
        this.logger = OutputChannelLogger_1.OutputChannelLogger.getMainChannel();
        this.projectRoot = projectRoot;
        this.iosProjectRoot = iosProjectRoot;
        this.simulatorPlist = new simulatorPlist_1.SimulatorPlist(this.iosProjectRoot, this.projectRoot, scheme);
    }
