...
class SimulatorPlist {
    constructor(iosProjectRoot, projectRoot, scheme, { nodeFileSystem = new fileSystem_1.FileSystem(), plistBuddy = new plistBuddy_1.PlistBuddy(), nodeChildProcess = new childProcess_1.ChildProcess(), } = {}) {
    ...
    findPlistFile(configuration, productName) {
        return Q.all([
            this.plistBuddy.getBundleId(this.iosProjectRoot, this.projectRoot, true, configuration, productName, this.scheme),
