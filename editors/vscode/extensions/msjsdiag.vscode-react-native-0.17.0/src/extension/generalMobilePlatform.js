...
class GeneralMobilePlatform {
    constructor(runOptions, platformDeps = {}) {
        ...
        this.packager = platformDeps.packager || new packager_1.Packager(this.runOptions.workspaceRoot, this.projectPath, settingsHelper_1.SettingsHelper.getPackagerPort(this.runOptions.workspaceRoot), new packagerStatusIndicator_1.PackagerStatusIndicator(this.projectPath));
