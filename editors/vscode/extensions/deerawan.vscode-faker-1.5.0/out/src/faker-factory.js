...
function fakerFactory(locale) {
    switch (locale) {
        ...
        case 'ar':
            return Promise.resolve().then(() => require('faker/locale/ar'));
        case 'cz':
        ...
        case 'en_ZA':
            return Promise.resolve().then(() => require('faker/locale/en_ZA'));
        case 'es':
        ...
        case 'fi':
            return Promise.resolve().then(() => require('faker/locale/fi'));
        case 'fr':
            return Promise.resolve().then(() => require('faker/locale/fr'));
        case 'fr_CA':
            return Promise.resolve().then(() => require('faker/locale/fr_CA'));
        case 'fr_CH':
            return Promise.resolve().then(() => require('faker/locale/fr_CH'));
        case 'ge':
        ...
        case 'nl_BE':
            return Promise.resolve().then(() => require('faker/locale/nl_BE'));
        case 'pl':
            return Promise.resolve().then(() => require('faker/locale/pl'));
        case 'pt_BR':
            return Promise.resolve().then(() => require('faker/locale/pt_BR'));
        case 'pt_PT':
            return Promise.resolve().then(() => require('faker/locale/pt_PT'));
        case 'ro':
            return Promise.resolve().then(() => require('faker/locale/ro'));
        case 'ru':
