...
- the Command Palette
- with a [keyboard shortcut](https://github.com/cyrilletuzi/vscode-angular-schematics/blob/master/./docs/KEYBOARD.md)
...
See the [troubleshooting guide](https://github.com/cyrilletuzi/vscode-angular-schematics/blob/master/./docs/TROUBLESHOOTING.md) for help.
...
but it is recommended to [adjust some Ionic settings](https://github.com/cyrilletuzi/vscode-angular-schematics/blob/master/./docs/IONIC.md).
