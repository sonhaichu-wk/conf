...
exports.ERROR_STRINGS = {
    ...
    [internalErrorCode_1.InternalErrorCode.PackagerRunningInDifferentPort]: localize(37, null),
    [internalErrorCode_1.InternalErrorCode.ErrorWhileProcessingMessageInIPMSServer]: localize(38, null),
    [internalErrorCode_1.InternalErrorCode.ErrorNoPipeFound]: localize(39, null),
    [internalErrorCode_1.InternalErrorCode.NotAllSuccessPatternsMatched]: localize(40, null),
    [internalErrorCode_1.InternalErrorCode.CouldNotParsePackageVersion]: localize(41, null),
    [internalErrorCode_1.InternalErrorCode.UnsupportedCommandStatus]: localize(42, null),
    [internalErrorCode_1.InternalErrorCode.ExpectedExponentTunnelPath]: localize(43, null),
    [internalErrorCode_1.InternalErrorCode.WorkspaceNotFound]: localize(44, null),
    [internalErrorCode_1.InternalErrorCode.RNVersionNotSupportedByExponent]: localize(45, null),
    [internalErrorCode_1.InternalErrorCode.UserCancelledExpoLogin]: localize(46, null),
    [internalErrorCode_1.InternalErrorCode.CannotAttachToPackagerCheckPackagerRunningOnPort]: localize(47, null),
    [internalErrorCode_1.InternalErrorCode.AnotherDebuggerConnectedToPackager]: localize(48, null),
    [internalErrorCode_1.InternalErrorCode.NotInReactNativeFolderError]: localize(49, null),
    [internalErrorCode_1.InternalErrorCode.SourcesStoragePathIsNullOrEmpty]: localize(50, null),
    [internalErrorCode_1.InternalErrorCode.AndroidCouldNotInstallTheAppOnAnyAvailibleDevice]: localize(51, null),
    [internalErrorCode_1.InternalErrorCode.AndroidShellCommandTimedOut]: localize(52, null),
    [internalErrorCode_1.InternalErrorCode.AndroidProjectNotFound]: localize(53, null),
    [internalErrorCode_1.InternalErrorCode.AndroidMoreThanOneDeviceOrEmulator]: localize(54, null),
    [internalErrorCode_1.InternalErrorCode.AndroidFailedToLaunchTheSpecifiedActivity]: localize(55, null),
    [internalErrorCode_1.InternalErrorCode.IOSFoundMoreThanOneExecutablesCleanupBuildFolder]: localize(56, null),
    [internalErrorCode_1.InternalErrorCode.IOSCouldNotFoundExecutableInFolder]: localize(57, null),
    [internalErrorCode_1.InternalErrorCode.WinRNMPPluginIsNotInstalled]: localize(58, null),
    [internalErrorCode_1.InternalErrorCode.ReactDevtoolsIsNotInstalled]: localize(59, null),
    [internalErrorCode_1.InternalErrorCode.DebuggingWontWorkReloadJSAndReconnect]: localize(60, null),
    [internalErrorCode_1.InternalErrorCode.ReconnectionToPackagerFailedCheckForErrorsOrRestartReactNative]: localize(61, null),
    [internalErrorCode_1.InternalErrorCode.FailedToProcessMessageFromReactNativeApp]: localize(62, null),
    [internalErrorCode_1.InternalErrorCode.FailedToPrepareJSRuntimeEnvironment]: localize(63, null),
    [internalErrorCode_1.InternalErrorCode.FailedToSendMessageToTheReactNativeApp]: localize(64, null),
    [internalErrorCode_1.InternalErrorCode.ReactNativeWorkerProcessThrownAnError]: localize(65, null),
    [internalErrorCode_1.InternalErrorCode.CouldntImportScriptAt]: localize(66, null),
    [internalErrorCode_1.InternalErrorCode.RNMessageWithMethodExecuteApplicationScriptDoesntHaveURLProperty]: localize(67, null),
};
