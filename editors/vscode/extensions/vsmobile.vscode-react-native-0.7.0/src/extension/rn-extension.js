...
function registerReactNativeCommands(context) {
    ...
    registerVSCodeCommand(context, "runInspector", errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.CommandFailed, "React Native: Run Element Inspector"), () => commandPaletteHandler_1.CommandPaletteHandler.runElementInspector());
}
