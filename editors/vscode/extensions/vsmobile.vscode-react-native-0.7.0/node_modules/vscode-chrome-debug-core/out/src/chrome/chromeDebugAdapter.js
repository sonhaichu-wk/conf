            ...
            if (targetScriptUrl) {
                ...
                return setBreakpointsPFailOnError.then(body => {
                    if (body.breakpoints.every(bp => !bp.verified)) {
                        return this.unverifiedBpResponseForBreakpoints(args, requestSeq, body.breakpoints, localize(3, null), true);
                    }
                ...
                return Promise.resolve(this.unverifiedBpResponse(args, requestSeq, localize(4, null)));
            }
        ...
        return responses
            ...
            if (thisBpRequest.hitCondition) {
                if (!this.addHitConditionBreakpoint(thisBpRequest, response)) {
                    return {
                        id: bpId,
                        message: localize(7, null, thisBpRequest.hitCondition),
                        verified: false
                    };
                }
            }
    ...
    stackTrace(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(stackTraceResponse.stackFrames.map((frame, i) => __awaiter(this, void 0, void 0, function* () {
                ...
                const getSkipReason = reason => localize(8, null, reason);
