...
import { Event, Source } from 'vscode-debugadapter';
import { ICommonRequestArgs, ILaunchRequestArgs, ISetBreakpointsArgs, ISetBreakpointsResponseBody, IStackTraceResponseBody, IAttachRequestArgs, IScopesResponseBody, IVariablesResponseBody, ISourceResponseBody, IThreadsResponseBody, IEvaluateResponseBody, ISetVariableResponseBody, IDebugAdapter, ICompletionsResponseBody, IToggleSkipFileStatusArgs, IAllLoadedScriptsResponseBody, IExceptionInfoResponseBody, ISetBreakpointResult, IRestartRequestArgs } from '../debugAdapterInterfaces';
...
export declare class ScriptEvent extends Event {
    body: {
        reason: 'new' | 'removed';
        script: Script;
    };
...
export declare abstract class ChromeDebugAdapter implements IDebugAdapter {
     ...
     */
    private sendScriptEvents(script);
    ...
    getLoadedScripts(): Promise<IAllLoadedScriptsResponseBody>;
    ...
    private logObjects(objs, isError?);
    ...
    private scriptToScriptEvent(script);
    ...
    private isEvalScript(scriptPath);
}
