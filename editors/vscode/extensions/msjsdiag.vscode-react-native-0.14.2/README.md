...
You can debug your app on an Android emulator, Android device or iOS simulator, iOS device. Please see the documentation for [debugging on iOS devices](https://github.com/Microsoft/vscode-react-native/blob/master/doc/debugging.md#debugging-on-ios-device).
...
The extension provides support of [VS Code Remote Development](https://code.visualstudio.com/docs/remote/remote-overview) features on Linux. For more details about configuring and debugging React Native Android applications inside Docker Container see [Containerization docs](https://github.com/Microsoft/vscode-react-native/blob/master/doc/containerization.md).
